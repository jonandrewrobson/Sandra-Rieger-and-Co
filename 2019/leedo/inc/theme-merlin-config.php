...
$wizard = new Merlin(
	...
	$strings = array(
		...
		'ready-link-1' => sprintf( '<a href="%1$s">%2$s</a>', admin_url( 'tools.php?page=regenerate-thumbnails' ), esc_html__( 'Regenerate Thumbnails', 'leedo' ) ),
		'ready-link-2' => sprintf( '<a href="%1$s">%2$s</a>', admin_url( 'customize.php' ), esc_html__( 'Start Customizing', 'leedo' ) ),
		'ready-link-3' => sprintf( '<a href="%1$s" target="_blank">%2$s</a>', 'https://vlthemes.ticksy.com/', esc_html__( 'Get Theme Support', 'leedo' ) ),
	)
);
