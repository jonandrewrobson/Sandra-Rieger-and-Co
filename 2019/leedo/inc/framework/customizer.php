...
VLT_Options::add_panel( 'panel_core', array(
	'title' => esc_html__( 'Core Options', 'leedo' ),
...
require_once LEEDO_REQUIRE_DIRECTORY . 'inc/framework/setup/section-core.php';
...
VLT_Options::add_section( 'section_header_animated', array(
	'panel' => 'panel_header_general',
	'title' => esc_html__( 'Header Animated', 'leedo' ),
	'priority' => $second_level++,
	'icon' => 'dashicons-arrow-right',
) );
...
VLT_Options::add_section( 'section_footer_style_7', array(
	'panel' => 'panel_footer',
	'title' => esc_html__( 'Footer Style 7', 'leedo' ),
	'priority' => $second_level++,
	'icon' => 'dashicons-arrow-right',
) );
...
VLT_Options::add_section( 'typography_additional', array(
	'panel' => 'panel_typography',
	'title' => esc_html__( 'Additional Options', 'leedo' ),
	'priority' => $second_level++,
 ...
 * Instagram
 */
VLT_Options::add_section( 'section_instagram', array(
	'title' => esc_html__( 'Instagram', 'leedo' ),
	'priority' => $second_level++,
	'icon' => 'dashicons-camera',
) );

require_once LEEDO_REQUIRE_DIRECTORY . 'inc/framework/setup/section-instagram.php';

/**
 * Mailchimp
 */
VLT_Options::add_section( 'section_mailchimp', array(
	'title' => esc_html__( 'Mailchimp', 'leedo' ),
	'priority' => $second_level++,
	'icon' => 'dashicons-email',
) );

require_once LEEDO_REQUIRE_DIRECTORY . 'inc/framework/setup/section-mailchimp.php';

/**
 * Advanced
 */
VLT_Options::add_section( 'section_advanced', array(
	'title' => esc_html__( 'Advanced', 'leedo' ),
	'priority' => 9999,
	'icon' => 'dashicons-star-filled',
) );

require_once LEEDO_REQUIRE_DIRECTORY . 'inc/framework/setup/section-advanced.php';