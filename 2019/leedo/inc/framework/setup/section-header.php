...
VLT_Options::add_field( array(
	...
	'choices' => array(
		...
		'animated' => esc_html__( 'Animated', 'leedo' ),
...
VLT_Options::add_field( array(
	...
	'settings' => 'shg_3',
	'section' => 'section_header_general',
	'default' => '<div class="kirki-separator">' . esc_html__( 'Search', 'leedo' ) . '</div>',
	'priority' => $priority++,
	'active_callback' => array(
		array(
			'setting' => 'navigation_show',
...
VLT_Options::add_field( array(
	...
	'section' => 'section_header_general',
	'label' => esc_html__( 'Search Icon', 'leedo' ),
	'priority' => $priority++,
	'transport' => 'auto',
	'choices' => array(
		'show' => esc_html__( 'Show', 'leedo' ),
...
VLT_Options::add_field( array(
	'type' => 'custom',
	'settings' => 'sha_1',
	'section' => 'section_header_animated',
	'default' => '<div class="kirki-separator">' . esc_html__( 'Logo', 'leedo' ) . '</div>',
	'priority' => $priority++,
) );
...
VLT_Options::add_field( array(
	'type' => 'image',
	'settings' => 'header_animated_logo_white',
	'section' => 'section_header_animated',
	'label' => esc_html__( 'Logo White', 'leedo' ),
	'priority' => $priority++,
	'transport' => 'auto',
...
VLT_Options::add_field( array(
	'type' => 'dimension',
	'settings' => 'header_animated_logo_height',
	'section' => 'section_header_animated',
	'label' => esc_html__( 'Logo Height', 'leedo' ),
	'priority' => $priority++,
	'transport' => 'auto',
	...
	'output' => array(
		array(
			'element' => '.vlt-header--animated .vlt-navbar-logo img',
			'property' => 'height'
		)
	)
) );
...
VLT_Options::add_field( array(
	'type' => 'select',
	'settings' => 'mobile_navigation_sticky',
	'section' => 'section_header_mobile',
	'label' => esc_html__( 'Sticky', 'leedo' ),
	'priority' => $priority++,
	'transport' => 'auto',
...
VLT_Options::add_field( array(
	'type' => 'select',
	'settings' => 'mobile_navigation_hide_on_scroll',
	'section' => 'section_header_mobile',
	'label' => esc_html__( 'Hide on Scroll', 'leedo' ),
	'priority' => $priority++,
	'transport' => 'auto',
	...
	'active_callback' => array(
		array(
			'setting' => 'mobile_navigation_sticky',
			'operator' => '==',
			'value' => 'enable',
		)
	),
