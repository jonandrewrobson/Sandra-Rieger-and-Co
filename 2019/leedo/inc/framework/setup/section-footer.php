...
VLT_Options::add_field( array(
	...
	'choices' => array(
		...
		'style-7' => esc_html__( 'Style 7', 'leedo' ),
...
VLT_Options::add_field( array(
	...
	'priority' => $priority++,
	'transport' => 'auto',
	'default' => '<p>© 2019 Leedo WordPress Theme. All rights reserved.</p>',
) );
...
VLT_Options::add_field( array(
	'type' => 'dimension',
	'settings' => 'footer_style-1_logo_height_mobile',
	'section' => 'section_footer_style_1',
	'label' => esc_html__( 'Logo Height Mobile', 'leedo' ),
	'priority' => $priority++,
	'transport' => 'auto',
	'default' => '',
	'output' => array(
...
VLT_Options::add_field( array(
	'type' => 'dimension',
	'settings' => 'footer_style-6_logo_height_mobile',
	'section' => 'section_footer_style_6',
	'label' => esc_html__( 'Logo Height Mobile', 'leedo' ),
	'priority' => $priority++,
	'transport' => 'auto',
...
VLT_Options::add_field( array(
	'type' => 'custom',
	'settings' => 'sfs7_1',
	'section' => 'section_footer_style_7',
	'default' => '<div class="kirki-separator">' . esc_html__( 'General', 'leedo' ) . '</div>',
	'priority' => $priority++,
) );
...
VLT_Options::add_field( array(
	'type' => 'editor',
	'settings' => 'footer_style-7_content',
	'section' => 'section_footer_style_7',
	'label' => esc_html__( 'Footer Content', 'leedo' ),
	'priority' => $priority++,
	'transport' => 'auto',
...
VLT_Options::add_field( array(
	'type' => 'background',
	'settings' => 'footer_style-7_background',
	'section' => 'section_footer_style_7',
	'label' => esc_html__( 'Footer Background', 'leedo' ),
	'priority' => $priority++,
	'transport' => 'auto',
	...
	'output' => array(
		array(
			'element' => '.vlt-footer.vlt-footer--style-7',
		),
	),
) );
