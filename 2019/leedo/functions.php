...
if ( LEEDO_WOOCOMMERCE ) {
	$leedo_theme_includes[] = 'woocommerce';
}

foreach ( $leedo_theme_includes as $file ) {
	require_once LEEDO_REQUIRE_DIRECTORY . 'inc/theme-' . $file . '.php';
}

// Unset the global variable.
unset( $leedo_theme_includes );