...
$header_class = 'vlt-header vlt-header--animated';
				...
				<div class="vlt-navbar-inner">
					...
					<div class="vlt-navbar-inner--left">
						...
						<a href="<?php echo esc_url( home_url( '/' ) ); ?>" class="vlt-navbar-logo">
							<?php if ( leedo_get_theme_mod( 'header_animated_logo' ) ) : ?>
								<img src="<?php echo leedo_get_theme_mod( 'header_animated_logo' ); ?>" alt="<?php bloginfo( 'name' ); ?>" class="black">
								<img src="<?php echo leedo_get_theme_mod( 'header_animated_logo_white' ); ?>" alt="<?php bloginfo( 'name' ); ?>" class="white">
							<?php else: ?>
					...
					<div class="vlt-navbar-inner--right">
						...
						<div class="d-flex align-items-center">
							...
							<?php get_template_part( 'template-parts/header/partials/partial', 'header-animated-icon' ); ?>
